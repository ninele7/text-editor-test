...
(function (mod) {
  ...
  { mod(require('codemirror/lib/codemirror'), require('codemirror/mode/xml/xml'), require('codemirror/mode/meta')) } else if (typeof define === 'function' && define.amd) // AMD
  { define(['codemirror/lib/codemirror', 'codemirror/mode/xml/xml', 'codemirror/mode/meta'], mod) } else // Plain browser env
  { mod(CodeMirror) }
})(function (CodeMirror) {
  'use strict'
